...
function Navbar() {
    return (
        <div className='bg-secondary-bg h-screen w-full flex flex-col'>
            <div className="logo flex flex-row items-center justify-center h-1/10 gap-5">
                ...
                <div className="title w-[70%] flex items-center justify-start font-header text-text-primary font-header text-xl">SpeerCheck</div>
            </div>
        </div>
    )
}
