...
const candidateColor = { border: "border-cand-orange-border", bg: "bg-eng-orange", hover: "hover:bg-eng-orange-hover" };
const overlapColor = { border: "border-cand-orange-border", bg: "bg-overlap", hover: "hover:bg-overlap-hover" };
